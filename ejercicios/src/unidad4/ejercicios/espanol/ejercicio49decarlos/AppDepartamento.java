...
public class AppDepartamento {
	...
	public static void main(String[] args) {
		...
		Villa m1= new Villa("Andujar", 35000, 14.2, 250.2, alcalde); // la villa tiene un alcalde
		Pedania m2= new Pedania("Villa de Andújar", 45000, 10.2, 455.2, m1); // pedania pertenece a una villa 
