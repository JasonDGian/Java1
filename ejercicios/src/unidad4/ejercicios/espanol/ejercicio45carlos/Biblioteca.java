package unidad4.ejercicios.espanol.ejercicio45carlos;
...
public class Biblioteca {
	...
	public Libro[] devuelveLibrosOrdenados() {

		Libro[] arrayRes = this.getLibros();
	...
	public Libro[] devuelveLibrosOrdenados(Comparator<Libro> comp) {

		Libro[] arrayRes = this.getLibros();

		Arrays.sort(arrayRes, comp);
