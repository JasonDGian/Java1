...
public class BlocNotas {
	...
	// metodos que no devuelven copia, estos metodos pueden causar side-effects.
	...
	public Nota[] devuelveNotasOrdenado() {

		Nota[] res = this.getNotas();

		// no devuelve nada, solo reordena el array.
		Arrays.sort(res);

		return res;
	}

	// con interfaz comparador generico.
	public Nota[] devuelveNotasOrdenado(Comparator<Nota> comp) {
