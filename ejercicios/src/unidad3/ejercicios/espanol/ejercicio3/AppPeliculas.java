...
public class AppPeliculas {
	...
	public static void main(String[] args) {
		...
		Pelicula gandhi = new Pelicula("Gandhi", "Richard Attenborough", GeneroPelicula.DRAMA, 191, 1982, 8.1);
		Pelicula thor = new Pelicula("Thor", "Kenneth Granagh", GeneroPelicula.ACCION, 115, 2011, 7);
