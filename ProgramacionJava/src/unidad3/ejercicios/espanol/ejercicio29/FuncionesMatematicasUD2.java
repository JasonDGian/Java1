...
public class FuncionesMatematicasUD2 {
	...
	static int quitaPorDelante(int num, int n) {
		...
		/*
		 * PAra quitar por delante, en lugar de truncar el numero con divisiones, usamos
		 * el teorema de la numeracion para obtener la cifra de los dos digitos a
		 * quitar, y esta cifra la restamos al numero original.
		 */
		...
		int restador = (int) (num / Math.pow(10, truncado)); // Despoja de los digitos que deseamos conservar al
																// restador
	...
	static void pegaPorDetras(int num, int digit) {
		...
		/*
		 * coge un numero dado y aumenta las posiciones de sus digitos en uno y luego le
		 * suma el digito dado con posicion 0. Ejemplo 1524 de posicion 3210 se
		 * convierte en 15240 de posicion 43210 y luego se le suma el digito. La manera
		 * mas sencilla de aumentar una posicion a todos los digitos es multiplicar por
		 * 10.
		 */
	...
	static int pegaPorDelante(int num, int digit) {
		/*
		 * cuenta los digitos del numero entregado suma el digito pasado multiplicado
		 * por las posiciones totales +1
		 */

		int numDigitos = countDigits(num);

		// En lugar de asignar a una variable el resutlado de la operación, devolvemos
		// la operacion en si misma.
