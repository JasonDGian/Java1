...
//The circle has radius of 2.0 and area of 12.566370614359172
		...
		System.out.println("Cricle 3 color is: " + c3.getColor());
		
		
		/* This summons an exception because the variables are not publicly available to other classes 
		 * except the one where it is declared (as private).*/
		// System.out.println("Cricle 3 color is: " + c3.color);
		...
		// explicit call	toString() is called implicitly when an instance is passed to println() method, for example,
